...
def getRandomFortune():
    fortunes = [
        "Thank you for freeing me from my crumbly prison",
        "Does anyone actually eat these things or are they just in it for me?",
        "Made in California (What, were you expecting China?)",
        "You will soon be enjoying many cookies... in bed. Expect ants"
    ]
